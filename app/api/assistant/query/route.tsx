...
const knowledgeBaseData = [
  ...
  },
  {
    ...
    answer_html:
      "<p>存戶可登入企業網路銀行線上辦理金融XML憑證停用。若需恢復使用，或曾親洽分行辦理憑證暫停，請持身分證、該分行存摺及原留印鑑親洽任一開戶行辦理憑證恢復。請注意，使用該憑證預約的網路銀行交易將在停用期間不予執行。</p>",
    quick_actions: [
      { text: "前往企業網銀登入", url: "/login" },
      { text: "查詢最近分行", url: "/branch-locator" },
    ],
  ...
  },
  {
    ...
    answer_html:
      "<ul><li>憑證的有效期限為一年，存戶應自行於憑證到期前一個月登入企業網路銀行申請展期。</li><li>若逾期未申請，該憑證將失效。此時，您須親洽任一開戶行辦理憑證註銷（持身分證、該分行存摺及原留印鑑），並另行書面辦理憑證申請手續（即申請新憑證）。</li></ul>",
    quick_actions: [
      { text: "前往企業網銀登入", url: "/login" },
      { text: "查詢最近分行", url: "/branch-locator" },
    ],
  ...
  },
  {
    ...
    category: "操作問題",
    tags: ["憑證", "電腦毀損", "跨電腦", "簽章"],
    question: "已將憑證成功啟用，但客戶端電腦毀損或欲在其他電腦上進行簽章，該如何處理？",
    answer_html:
      "<p>請在新電腦上於企業網路銀行首頁點選【環境檢核】，依檢核工具提示調整相關設定。此外，您也可以使用Chrome、Firefox、Safari等瀏覽器，並於【軟體下載】安裝相關元件（或驅動程式）。</p>",
    quick_actions: [{ text: "前往軟體下載", url: "/download" }],
  },
  {
    id: "OPR-05",
  ...
  },
  {
    id: "OPR-06",
    category: "操作問題",
    tags: ["交易反悔", "撤銷交易", "已送出交易"],
    question: "填寫完交易資料後，並已按下確定鍵送出，可是我要反悔此筆交易，可以嗎？",
    answer_html:
      "<p>使用者填寫要進行的交易資料後，系統會請使用者再三確認本筆交易是否確定要送出。一旦經使用者確認並送出之後，系統會自動將使用者的簽章及本筆交易資料一併送出至銀行的交易系統內進行交易搓合。交易一旦送出，即視同有效之交易需求，使用者無法於線上要求撤銷此筆交易需求。</p>",
    quick_actions: [],
  },
  {
    id: "OPR-07",
    category: "操作問題",
    tags: ["憑證", "多家銀行", "交易錯亂", "共用"],
    question: "如果申請多家銀行的憑證並放在電腦內，會不會造成交易錯亂的困擾，或是產生其他後遺症？",
    answer_html:
      "<p>不會。如果您是多家銀行的顧客，並且已經申請了多家銀行的網路交易憑證，這些憑證將會存放在您的電腦中。您無需擔心系統會選錯憑證進行交易，因為每家銀行的憑證都有自己的代碼，系統會自動選擇符合銀行代碼的憑證，並取來進行交易。</p>",
    quick_actions: [],
  },
  {
    id: "LOGIN-01",
    category: "帳號登入與密碼問題",
    tags: ["忘記", "使用者名稱", "帳號", "查詢"],
    question: "我忘記我的使用者名稱了，怎麼辦？",
    answer_html:
      "<p>您可以請公司的「授權主管」登入企業網銀，在「管理服務」的「使用者管理」功能中，幫您查詢您的使用者名稱。</p>",
    quick_actions: [{ text: "前往企業網銀登入", url: "/login" }],
  },
  {
    id: "LOGIN-02",
    category: "帳號登入與密碼問題",
    tags: ["6305", "錯誤代碼", "帳號鎖定", "密碼錯誤"],
    question: "我無法登入，畫面顯示錯誤代碼「6305」，該怎麼辦？",
    answer_html:
      "<p>您好，出現這個訊息表示您的帳號已被鎖定，通常是密碼輸入錯誤次數過多造成的。請聯繫貴公司的<strong>「授權主管」，請他們登入企業網銀，進入「管理服務 > 使用者管理」功能，為您辦理「密碼重置」</strong>來解鎖帳號。重置後，您會收到一封密碼重置信件，再依信件說明操作即可。</p>",
    quick_actions: [{ text: "前往企業網銀登入", url: "/login" }],
  },
  {
    id: "LOGIN-03",
    category: "帳號登入與密碼問題",
    tags: ["E945", "使用者代號錯誤", "密碼重置"],
    question: "我辦理密碼重置後要變更密碼，卻出現「錯誤代碼:E945-使用者代號錯誤」？",
    answer_html:
      "<p>這是因為在「使用者代號」欄位，您可能輸入了舊的代號。請您參考銀行提供的<strong>「網路銀行密碼單」，並在【請輸入新的使用者代號】欄位中，輸入密碼單上的「使用者代號初值」</strong>即可完成設定。</p>",
    quick_actions: [],
  },
  {
    id: "LOGIN-04",
    category: "帳號登入與密碼問題",
    tags: ["6350", "重複登入", "無痕模式"],
    question: "我無法登入，畫面顯示「6350 您已有使用其他帳號登入...」的訊息，但我沒有開著其他視窗。",
    answer_html:
      "<p>這可能是瀏覽器還留有您上次登入的紀錄。請您使用瀏覽器的<strong>「無痕模式」</strong>或「私密瀏覽」功能來重新登入，就可以解決這個問題。<br>* Chrome / Edge: 按下 Ctrl + Shift + N<br>* Internet Explorer: 按下 Ctrl + Shift + P</p>",
    quick_actions: [],
  },
  {
    id: "LOGIN-05",
    category: "帳號登入與密碼問題",
    tags: ["加密異常", "時間不正確", "登入問題"],
    question: "我登入時出現「加密異常」的訊息，這是什麼問題？",
    answer_html:
      "<p>這個訊息通常是您<strong>電腦的「時間不正確」</strong>所導致。請先確認您電腦右下角的日期、時間是否為現在的標準時間。如果時間正確，也可能是您在頁面停留過久，請將瀏覽器整個關閉再重新登入。</p>",
    quick_actions: [],
  },
  {
    id: "LOGIN-06",
    category: "帳號登入與密碼問題",
    tags: ["密碼規定", "設定規則", "安全"],
    question: "設定登入密碼有什麼規定嗎？",
    answer_html:
      "<p>為了您的帳戶安全，密碼設定請遵守以下規則：<br>1. 長度需介於8至16個字元，且會區分英文大小寫。<br>2. 必須是英文和數字的組合，不能有空格或三個以上相同的字元。<br>3. 不能使用您的使用者代號或特殊符號。</p>",
    quick_actions: [],
  },
  {
    id: "LOGIN-07",
    category: "帳號登入與密碼問題",
    tags: ["使用者代號", "設定限制", "規則"],
    question: "設定使用者代號（使用者名稱）有什麼限制？",
    answer_html:
      "<p>設定使用者代號時請注意：<br>1. 長度需介於6至20個字元，由英文和數字組成。<br>2. 不能輸入中文或空格，且需避免使用如Admin、Landbank等系統保留字。</p>",
    quick_actions: [],
  },
  {
    id: "TRANS-01",
